...
function showHero(hero) {
  ...
  myCopy.querySelector(
    ".powers"
  ).textContent = `Their powers are: ${hero.powers}`;
  myCopy.querySelector(
    ".sidekick h2"
  ).textContent = `Their Sidekick is: ${hero.sidekick.name}`;
  myCopy.querySelector(
    ".mission"
  ).textContent = `Their superhero mission: ${hero.mission}`;
  myCopy.querySelector(
    ".outfit"
  ).textContent = `They're wearing: ${hero.outfit}`;
  myCopy.querySelector(
    ".weakness"
  ).textContent = `Their weakness is: ${hero.weaknesses}`;
  myCopy.querySelector(
    ".enemies"
  ).textContent = `Their enemies are: ${hero.enemies}`;
